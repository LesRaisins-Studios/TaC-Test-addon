package me.xjqsh.exampletacaddon.client.render.gun.model;
 ...
 */
public class hcar_animation extends SkinAnimationModel {
    ...
    public void render(float v, ItemCameraTransforms.TransformType transformType, ItemStack stack, ItemStack parent, LivingEntity entity, MatrixStack matrices, IRenderTypeBuffer renderBuffer, int light, int overlay) {
        ...
        matrices.pushPose();
        {
            controller.applySpecialModelTransform(getModelComponent(skin, BODY), HCARAnimationController.INDEX_EXTRA_MAG, transformType, matrices);
