...
public class ThrowableItemRenderer extends EntityRenderer<ThrowableItemEntity> {
    ...
    public void render(ThrowableItemEntity entity, float entityYaw, float partialTicks, MatrixStack stack, IRenderTypeBuffer renderTypeBuffer, int light) {
        ...
        Minecraft.getInstance().getItemRenderer().renderStatic(entity.getItem(), ItemCameraTransforms.TransformType.NONE, light, OverlayTexture.NO_OVERLAY, stack, renderTypeBuffer);
        stack.popPose();
    }
