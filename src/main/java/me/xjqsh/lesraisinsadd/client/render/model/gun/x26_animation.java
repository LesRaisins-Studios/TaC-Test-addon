 ...
 */
public class x26_animation extends SkinAnimationModel {

    @Override
    public void render(float v, ItemCameraTransforms.TransformType transformType, ItemStack stack, ItemStack parent, LivingEntity entity, MatrixStack matrices, IRenderTypeBuffer renderBuffer, int light, int overlay) {
        X26AnimationController controller = X26AnimationController.getInstance();
        GunSkin skin = SkinManager.getSkin(stack);

        matrices.pushPose();
        {
            controller.applySpecialModelTransform(getModelComponent(skin, BODY), X26AnimationController.INDEX_BODY, transformType, matrices);
        ...
        matrices.pushPose();
        {
            controller.applySpecialModelTransform(getModelComponent(skin, BODY), X26AnimationController.INDEX_MAG, transformType, matrices);
